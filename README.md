...
- **[JammBox](https://github.com/KerHack-Libre/JammBox)** - A collection of classic DOS games, already configured to work easily with DOSBox, via a lightweight user interface (TUI). - **[@jukoo](https://github.com/Jukoo)**
