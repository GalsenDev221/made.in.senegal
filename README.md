...
-   **[client-ip-details](https://github.com/sarequl/client-ip-details)** - You can detect requested client full IP details with this package. (isp, organization, location, residential/data center, proxy, etc). **by [@sarequl](https://github.com/sarequl)**
...
-   **[Netflix Helper](https://github.com/sarequl/Netflix-Helper)** - This Netflix Helper Chrome Extension will improve your Netflix streaming experience. This extension is to control volume with the mouse wheel, auto skips the intro, hide the unnecessary sections. **by [@sarequl](https://github.com/sarequl)**
